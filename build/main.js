...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_examples_service__ = __webpack_require__(8);
...
/* harmony default export */ exports["a"] = __WEBPACK_IMPORTED_MODULE_0_express__["Router"]().post('/', __WEBPACK_IMPORTED_MODULE_1__controller__["a" /* default */].create.bind(__WEBPACK_IMPORTED_MODULE_1__controller__["a" /* default */])).get('/', __WEBPACK_IMPORTED_MODULE_1__controller__["a" /* default */].all.bind(__WEBPACK_IMPORTED_MODULE_1__controller__["a" /* default */]));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_shoes_service__ = __webpack_require__(9);

class Controller {
  all(req, res) {
    __WEBPACK_IMPORTED_MODULE_0__services_shoes_service__["a" /* default */].all().then(r => res.json(r));
  }

  one(req, res) {
    __WEBPACK_IMPORTED_MODULE_0__services_shoes_service__["a" /* default */].one(req.params.id).then(r => res.status(200).json(r));
  }
}
/* unused harmony export Controller */
...
class shoesService {
  ...
  one(id) {
    ...
    var ids = shoes.find(el => {
      if (el.id == id) return el;
    });
    return Promise.resolve(ids);
  }
}
/* unused harmony export shoesService */


/* harmony default export */ exports["a"] = new shoesService();
...
"use strict";
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_swagger_express_middleware__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_controllers_shoes_router__ = __webpack_require__(7);
...
function routes(app) {
  ...
  app.use('/api/v1/shoes', __WEBPACK_IMPORTED_MODULE_1__api_controllers_shoes_router__["a" /* default */]);
};
